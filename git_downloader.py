        ...
        try:
            ...
            def download_progress(block_num, block_size, total_size):
                ...
                if total_size > 0:
                    ...
                    # Mostrar en KB o MB según el tamaño
                    if total_size < 1024 * 1024:  # Menor a 1MB
                        downloaded_kb = downloaded // 1024
                        total_kb = total_size // 1024
                        self._report_progress(
                            f"Descargando... {downloaded_kb}KB / {total_kb}KB",
                            percent
                        )
                    else:
                        ...
                        self._report_progress(
                            f"Descargando... {downloaded_mb}MB / {total_mb}MB",
                            percent
                        )
            ...
            with zipfile.ZipFile(zip_path, 'r') as zip_ref:
                ...
                if extracted_folders:
                    ...
                    # Directorios a excluir (no necesarios en la instalación)
                    excluded_dirs = {'dist', 'build', 'installer', '__pycache__', '.git', '.github'}
